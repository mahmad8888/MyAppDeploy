...
USERNAME_PASSWORD_PAIRS=[['username', 'password'], ['ahmad', 'mohamed']]
...
nsdq = pd.read_csv('https://raw.githubusercontent.com/mahmad8888/DataRepo/main/NASDAQcompanylist.csv')
